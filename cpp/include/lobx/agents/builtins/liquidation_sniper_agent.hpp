...
class LiquidationSniperAgent final : public IAgent {
public:
  LiquidationSniperAgent(AgentId id, const AgentConfig& config);

  AgentId id() const override { return id_; }
  AgentType type() const override { return AgentType::LiquidationSniper; }
