...
class FundingArbitrageAgent final : public IAgent {
public:
  FundingArbitrageAgent(AgentId id, const AgentConfig& config);

  AgentId id() const override { return id_; }
  AgentType type() const override { return AgentType::FundingArbitrageur; }
