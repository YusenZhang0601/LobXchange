...
class HawkesPanicAgent final : public IAgent {
public:
  HawkesPanicAgent(AgentId id, const AgentConfig& config);

  AgentId id() const override { return id_; }
  AgentType type() const override { return AgentType::HawkesPanic; }
