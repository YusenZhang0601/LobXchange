...
class OfiMomentumAgent final : public IAgent {
public:
  OfiMomentumAgent(AgentId id, const AgentConfig& config);

  AgentId id() const override { return id_; }
  AgentType type() const override { return AgentType::OfiMomentum; }
